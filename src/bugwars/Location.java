...
public class Location {
    ...
    /**
     * Constructor d'una nova Location. Inicialitza les coordenades als valors donats.
    ...
    public Location add(Direction dir) {
        if (dir == null) {
            System.err.println("Trying to add a null direction!");
    ...
    public Direction directionTo(Location loc) {
        if (loc == null) {
            System.err.println("Trying to get the direction to a null Location!");
            ThreadManager.punish();
    ...
    public int distanceSquared(Location loc) {
        if (loc == null) {
            System.err.println("Trying to take the distance to with a null Location!");
            ThreadManager.punish();
            return 0;
        }
